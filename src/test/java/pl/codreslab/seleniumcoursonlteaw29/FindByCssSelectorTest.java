...
public class FindByCssSelectorTest {
    ...
    public void findElementsByCssSelector() {
        ...
        emailRegistrationInput.sendKeys("sira@siarzewski.pl");
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
        WebElement myAddressesButton = driver.findElement(By.cssSelector("a[title='Addresses']"));
        WebElement informationButton = driver.findElement(By.cssSelector("a[title='Information']"));
